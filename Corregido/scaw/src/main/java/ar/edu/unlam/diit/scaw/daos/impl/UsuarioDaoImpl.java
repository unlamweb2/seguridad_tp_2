	...
	//obtengo los participantes de una tarea
	 ...
	 //guardar
	 	...
	 	public void modificarUsuario(Integer idUsuario, String nickName,String nombreU, String apellidoU, String contrasenaU,Integer estaParobado) {
            ...
            md.update(contrasenaU.getBytes());
            byte[] mb = md.digest();
	 		
            
            
	 		Map<String, Object> params3 = new HashMap<String, Object>();
	 		String sqlContrasena= "UPDATE USUARIO SET CONTRASENA ='" + mb.toString()  + "'  WHERE ID =" + SqlId;
	 	...
	 	public void aprobarUsuarioBdd(Usuario usuario) {
	 		...
	 		String sql= "UPDATE USUARIO SET ESTAAPROBADO = 1 WHERE ID =" +" "+  ESAPI.encoder().encodeForSQL(new DB2Codec(), sql2 );
	 	...
	 	public void eliminarUnUsuarioBdd(Integer idUsuario) {
	 	   ...
	 	   //mejora usando ESAPI para ocultar id
	 	    
	 	    
	 			Map<String, Object> params = new HashMap<String, Object>();
	 			String sql2 = idUsuario.toString();
	 			String sql= "DELETE FROM USUARIO WHERE ID =" +   ESAPI.encoder().encodeForSQL(new DB2Codec(), sql2 );
	 ...
	 //--
	 	...
	 	public List<Usuario> buscaUsuariosEnLaBDD(String nombreUsuario,Integer idUsuarioActual) {
	 		Map<String, Object> params = new HashMap<String, Object>();
			String sql = "SELECT * FROM USUARIO WHERE NOMBRE LIKE '" + nombreUsuario + "%' AND TIPO = 'usuarioNormal' AND ID != " +" "+  ESAPI.encoder().encodeForSQL(new DB2Codec(), idUsuarioActual.toString() );
		...
		public List<Usuario> getUsuarioPorNickNameBdd(String nickName) {
	 		...
	 		String sql = "SELECT * FROM USUARIO WHERE NICKNAME= '" +  ESAPI.encoder().encodeForSQL(new DB2Codec(), nickName ) + "'" ;
