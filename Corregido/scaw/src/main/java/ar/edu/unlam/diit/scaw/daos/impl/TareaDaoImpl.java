...
public class TareaDaoImpl  implements TareaDao{
	...
	public void eliminarParticipanteDeUnaTarea(Integer idTarea, Integer idParticipante) {
		Map<String, Object> params = new HashMap<String, Object>();	
 		String sql ="DELETE FROM ACCEDETAREA WHERE IDUSUARIO = '" + ESAPI.encoder().encodeForSQL(new DB2Codec(), idParticipante.toString() )+"'" +" AND IDTAREA = '" + ESAPI.encoder().encodeForSQL(new DB2Codec(), idTarea.toString() ) +"'";
	...
	public void eliminarTareaPorId(Integer idTarea) {
		Map<String, Object> params = new HashMap<String, Object>();
			...
			String sql= "DELETE FROM TAREA WHERE ID =" + " " + ESAPI.encoder().encodeForSQL(new DB2Codec(), sql2 );
			jdbcTemplate.update(sql, params);
	...
	public void setearEstadoTareaBdd(Integer idTarea, String estado) {
		...
		Map<String, Object> params = new HashMap<String, Object>();
 		...
 		String sql= "UPDATE TAREA SET ESTADO = '" + ESAPI.encoder().encodeForSQL(new DB2Codec(), estado ) + " "  + "' WHERE ID =" + ESAPI.encoder().encodeForSQL(new DB2Codec(), SqlId );
 		jdbcTemplate.update(sql, params );
	...
	public List<AccedeTarea> traerTodosLosAccedeTareaPorIdTarea(Integer idTarea) {
		String sql2= idTarea.toString();
		Map<String, Object> params = new HashMap<String, Object>();
		String sql = "SELECT * FROM ACCEDETAREA WHERE IDTAREA = " + " " + ESAPI.encoder().encodeForSQL(new DB2Codec(), sql2 );
	...
	public List<Tarea> getListaDeTareasPorIdDeUsuario(Integer idUsuario) {
		...
		Map<String, Object> params = new HashMap<String, Object>();
		String sql = "SELECT * FROM ACCEDETAREA WHERE IDUSUARIO = " + " " + ESAPI.encoder().encodeForSQL(new DB2Codec(), sql2 ) ;
